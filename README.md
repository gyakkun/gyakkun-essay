...
本仓库记录了本人毕业设计从纯文本起稿到Latex完稿的全过程, 期间受到了许多同学、同好、网友们的帮助, 特别感谢@jiepng (jipeng)在Latex排版时提供的大力帮助, 没有他的工作我可能就要依赖Word还有Onedrive提供的版本管理来排版了, 依赖ms怎么能体现出我们的程序员气质呢(笑)。

本项目公开时已通过rebase将人名等敏感信息去除。

本项目的构建离不开[**sysuthesis**](https://gitlab.com/sysu-gitlab/latex-group/thesis)项目, 它是校友们发起并维护的毕业论文Latex模板, 在此对前人们的工作表示由衷的感谢。

以下是sysuthesis项目README原文。
